<x-layouts.app
    title="Criar conta"
    description="Crie sua conta FANORA e descubra conteúdo exclusivo de creators. Plataforma para maiores de 18 anos."
>
            ...
            <form method="post" action="{{ route('register') }}" class="mt-6 space-y-5">
                ...
                <div class="relative overflow-hidden rounded-xl border-2 border-amber-500/70 bg-gradient-to-r from-amber-500/15 via-orange-500/10 to-amber-500/15 p-4 backdrop-blur-sm">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-amber-300">Conteúdo para maiores de 18 anos</p>
                            <p class="mt-1 text-xs leading-relaxed text-amber-200/90">Somente maiores de 18 anos. Ao criar uma conta você confirma sua maioridade legal.</p>
                        </div>
                    </div>
                ...
                <div class="flex items-start gap-2.5">
                    ...
                    <label for="terms" class="text-sm text-brand-muted">
                        Aceito os <a href="{{ route('terms') }}" target="_blank" class="font-medium text-brand-magenta underline hover:text-white">Termos de Uso</a>
                    </label>
                </div>
                @if ($errors->has('terms'))
                ...
                <div class="flex items-start gap-2.5">
                    ...
                    <label for="privacy" class="text-sm text-brand-muted">
                        Aceito a <a href="{{ route('privacy') }}" target="_blank" class="font-medium text-brand-magenta underline hover:text-white">Política de Privacidade</a>
                    </label>
                </div>
                ...
                <x-button type="submit" block>Criar conta</x-button>
            </form>
